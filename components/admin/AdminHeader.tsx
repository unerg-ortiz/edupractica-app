...
import { CheckCircle2, Shapes, Users, BarChart2, User, LogOut, Menu, X } from 'lucide-react';
        ...
        <header className="sticky top-0 z-50 bg-[#080C14]/95 backdrop-blur-lg border-b border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    {/* Logo */}
                    <Link href={`/${lang}/admin/content-review`} className="flex items-center gap-3 group">
